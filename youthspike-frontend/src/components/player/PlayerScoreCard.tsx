...
function PlayerScoreCard({
  ...
  const renderPlayerImage = (): React.ReactNode => {
    if (player && player.profile) {
      return <CldImage crop="fit" alt={player.firstName} width="200" height="200" className="w-full h-full object-top object-cover" src={player.profile} onClick={handleDropDown} />
    }
