...
import { IAccessCode, IMatchRelatives, INetRelatives, IPlayer, IRoom, IServerReceiverSinglePlay } from '@/types';
...
function RevertPreviousDialog({revertPlayEl, currPlays, socket, dispatch, currMatch, netByNum, currNetNum, token, accessCode, currRoom, playerMap, teamAPlayers, teamBPlayers}: IRevertPreviousDialogProps) {
