...
function EventPagination({
    ...
    for (let i = 0; i < pages; i++) {
        if (i === 0) {
            pageButtons.push(
                <button
                    ...
                    onClick={(e) => handlePagination(e, i, false)}
                    type="button"
                >
                    Previous
                </button>
        ...
        pageButtons.push(
            <button
                key={i + 1}
                className="btn-primary h-12 w-12"
        ...
        if (i === pages - 1) {
            pageButtons.push(
                <button
                    key={`${i + 1}-next`}
                    className="btn-primary h-12"
                    onClick={(e) => handlePagination(e, i, true)}
                    type="button"
                >
                    Next
                </button>
    ...
    return (
        <div className="pagination flex justify-center items-center gap-x-1">
            {pageButtons}
        </div>
    );
}
