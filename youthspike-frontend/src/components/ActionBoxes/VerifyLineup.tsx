                ...
                <div className={`w-full flex justify-between items-center border-t ${border.light}`}>
                    <div className="players w-4/6 p-1 text-start flex justify-between items-center">
                        <div className="player-wrapper w-3/6 px-1">
                            <PlayerScoreCard player={playerA ? playerA : null} dark={false} screenWidth={screenWidth} myTeamE={myTeamE} />
                        </div>
                        <div className="player-wrapper w-3/6 px-1">
                            <PlayerScoreCard player={playerB ? playerB : null} dark={false} screenWidth={screenWidth} myTeamE={myTeamE} />
                        </div>
                    </div>
