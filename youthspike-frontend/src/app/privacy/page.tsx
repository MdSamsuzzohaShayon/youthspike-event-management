  ...
  return (
    <div className="bg-gray-900 min-h-screen py-12 px-4">
      <div className="container mx-auto max-w-5xl bg-gray-700 shadow-lg rounded-lg p-8">
        <h1 className="text-4xl font-bold text-center text-gray-100 mb-6">Privacy Policy</h1>
        ...
        <h2 className="text-2xl font-semibold text-gray-100 mt-8 mb-4">1. Information We Collect</h2>
        <p className="text-gray-300 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-100 mt-8 mb-4">2. How We Use Your Information</h2>
        <p className="text-gray-300 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-100 mt-8 mb-4">3. Data Security</h2>
        <p className="text-gray-300 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-100 mt-8 mb-4">4. Third-Party Sharing</h2>
        <p className="text-gray-300 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-100 mt-8 mb-4">5. Cookies</h2>
        <p className="text-gray-300 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-100 mt-8 mb-4">6. Your Rights</h2>
        <p className="text-gray-300 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-100 mt-8 mb-4">7. Changes to This Policy</h2>
        ...
        <h2 className="text-2xl font-semibold text-gray-100 mt-8 mb-4">8. Contact Us</h2>
        <p className="text-gray-300 mb-4">
        ...
        <div className="text-center mt-12">
          <p className="text-gray-300">© 2024 Spikeball Tournament. All Rights Reserved.</p>
        </div>
      </div>
    </div>
  );
