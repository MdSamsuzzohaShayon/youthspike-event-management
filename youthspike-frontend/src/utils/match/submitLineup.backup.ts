...
import { INetRelatives, IPlayer, IRoom, IRoundRelatives } from '@/types';
...
const submitLineup = ({ dispatch, currRoom, myTeamE, currentRoundNets, currRound, myPlayers, roundList, closePSCAvailable }: ISubmitLineupProps) => {
  if (!currRoom) return;
