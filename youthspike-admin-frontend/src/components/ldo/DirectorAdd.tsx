...
function DirectorAdd({ update, prevLdo, setIsLoading, setAddNetDirector, ldoId, refetchFunc }: DirectorAddProps) {
  ...
  return (
    <motion.div className="flex justify-center items-center " initial="hidden" animate="visible" variants={containerVariants}>
      <motion.form onSubmit={handleDirectorSubmit} className="w-full md:bg-gray-900 text-white md:rounded-xl md:shadow-xl p-2 md:p-12 md:border md:border-gray-800" variants={containerVariants}>
        {/* Title */}
        <motion.h2 className="text-3xl md:text-4xl font-bold text-center text-yellow-400 mb-8" variants={inputVariants}>
