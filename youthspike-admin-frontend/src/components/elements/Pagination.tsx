...
function Pagination({ currentPage, setCurrentPage, itemList, ITEMS_PER_PAGE }: IPaginationProps) {
  ...
  return (
    <div className="flex items-center justify-center space-x-6 mt-6 p-4 rounded-lg shadow-xl">
      <button
        type="button"
        onClick={handlePrev}
      ...
      <span className="text-lg font-bold text-yellow-400 px-8 py-3 rounded-full shadow-md border border-yellow-400">
