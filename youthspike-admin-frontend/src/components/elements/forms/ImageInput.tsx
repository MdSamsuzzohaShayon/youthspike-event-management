  ...
  const renderImage = useMemo(() => {
    ...
    if (!filename || filename === '') {
      if (defaultValue && typeof defaultValue === 'string') {
        imgEl = <CldImage width={100} height={100} crop="fit" role="presentation" onClick={handleOpenImg} className="w-full object-cover object-center" sizes="100vw" alt="Description of my image" src={defaultValue} />;
      }
    } else {
